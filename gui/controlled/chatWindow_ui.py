...
class Ui_friend_msgBox(object):
    def setupUi(self, friend_msgBox):
        ...
        self.gridLayout.addWidget(self.ask_for_control_button, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.control_label, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.commandLinkButton_2, 8, 1, 1, 1)
        self.control_text = QtWidgets.QLabel(self.centralwidget)
        self.control_text.setObjectName("control_text")
        self.gridLayout.addWidget(self.control_text, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.show_his_ssh_commands_rb, 9, 1, 1, 1)
